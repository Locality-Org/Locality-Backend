...
router.route('/verifyFBToken')
    .get((req, res) => {
        res.json("Vendor verifyFBToken GET Request");
    })
    .post((req, res, next) => {
...
router.route('/login')
    ...
    .get((req, res) => {
        res.json("Vendor LogIn Page GET Request");
    })
    .post((req, res, next) => {
...
router.route('/signup')
    .all(user_auth.verifyFBTokenMiddleWare)
    .get((req, res) => {
        return res.json("Vendor SignUp Page GET Request");
    })
...
router.route('/sendOTP')
    .get((req, res) => {
        return res.json("Vendor SendOTP Page GET Request");
    })
    .post(async (req, res, next) => {
...
router.route('/verifyOTP')
    .get((req, res) => {
        return res.json("Vendor VerifyOTP Page GET Request");
    })
    .post(async (req, res, next) => {
